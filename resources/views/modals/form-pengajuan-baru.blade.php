...
<div class="modal fade" id="kt_modal_form_pengajuan_baru" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-1000px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_form_pengajuan_baru_header">
                <h2 class="fw-bolder">Formulir Pengajuan Baru Kerja Sama</h2>
            ...
            <form id="kt_modal_form_pengajuan_baru_form" class="form" enctype="multipart/form-data">
                @csrf
                <div class="modal-body py-10 px-lg-17">
                    <div class="scroll-y me-n7 pe-7"
                         id="kt_modal_form_pengajuan_baru_scroll"
                         data-kt-scroll="true"
                         data-kt-scroll-activate="{default: false, lg: true}"
                         data-kt-scroll-max-height="auto"
                         data-kt-scroll-dependencies="#kt_modal_form_pengajuan_baru_header"
                         data-kt-scroll-wrappers="#kt_modal_form_pengajuan_baru_scroll"
                        ...
                        <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-10 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                <div class="fw-bold">
                                    <h4 class="text-gray-900 fw-bolder">Dokumen Persyaratan Pengajuan Baru</h4>
                                    <div class="fs-6 text-gray-700">
                                        Siapkan dokumen berikut dalam format <strong>PDF (maks. 2MB)</strong> per file:
                                        Profil &amp; Denah Fasyankes, STR Tenaga Kesehatan, MOU Limbah.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Shared fields --}}
                        @include('modals._form-fields', ['modalId' => 'kt_modal_form_pengajuan_baru'])
                ...
                <div class="modal-footer flex-center">
                    ...
                    <button type="submit" id="btn_submit_baru" class="btn btn-primary">
